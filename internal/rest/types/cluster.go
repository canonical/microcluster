...
type ClusterMember struct {
	...
	SchemaInternalVersion int          `json:"schema_internal_version" yaml:"schema_internal_version"`
	SchemaExternalVersion int          `json:"schema_external_version" yaml:"schema_external_version"`
